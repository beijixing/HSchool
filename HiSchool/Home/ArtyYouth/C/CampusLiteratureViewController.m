//
//  CampusLiteratureViewController.m
//  HiSchool
//
...
//
//校园文学
#import "CampusLiteratureViewController.h"
#import "CampusLiteratureTableViewCell.h"
#import "CampusLiteratureDetailViewController.h"
@interface CampusLiteratureViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
{
...
@implementation CampusLiteratureViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CampusLiteratureTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:string];
    if (cell == nil) {
        cell = [[[NSBundle mainBundle]loadNibNamed:@"CampusLiteratureTableViewCell" owner:self options:nil]lastObject];
    }
    ...
    cell.typeLbl.text = @"散文";
    cell.titleLbl.text = @"故乡的月儿何时圆";
    cell.authorLbl.text = @"康师傅";
    cell.universityLbl.text = @"北宋梁山一私塾";
    cell.timeLbl.text = @"1111.11.11";
    cell.numLbl.text = @"1234";
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    CampusLiteratureDetailViewController *detail = [[CampusLiteratureDetailViewController alloc]init];
