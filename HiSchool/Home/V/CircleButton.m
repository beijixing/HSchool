...
- (void)addButtonImage:(UIImage *)image andSelectedImage:(UIImage *)selectedImage {
    ...
    [self.cirCleButton setImage:selectedImage forState:UIControlStateSelected];
}
...
- (void)layoutSubviews {
    ...
    [self.cirCleButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.size.mas_equalTo(CGSizeMake(self.frame.size.height - 30, self.frame.size.height - 30));
