//
//  StudentPhotographyViewController.m
//  HiSchool
//
...
//
//学生摄影
#import "StudentPhotographyViewController.h"
#import "StudentPhotographyTableViewCell.h"
@interface StudentPhotographyViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
{
...
@implementation StudentPhotographyViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    StudentPhotographyTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:string];
    if (cell == nil) {
        cell = [[[NSBundle mainBundle]loadNibNamed:@"StudentPhotographyTableViewCell" owner:self options:nil]lastObject];
    }
    return cell;
}
