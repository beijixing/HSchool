...
//
//热点论战
#import "NewsHotspotsViewController.h"
#import "NewsHotspotsTableViewCell.h"
#import "HotspotsDetailViewController.h"
#import "NewsHotspotsUploadVC.h"    //上传
@interface NewsHotspotsViewController ()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
{
...
@implementation NewsHotspotsViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    HotspotsDetailViewController *hotspots = [[HotspotsDetailViewController alloc]init];
    [self.navigationController pushViewController:hotspots animated:YES];
